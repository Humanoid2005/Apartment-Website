      ...
      {modal && (
        <div className="modal">
          <div className="modal-content">
            ...
            <form className="confirm-delete-form" action={`https://apartment-website-production.up.railway.app/api/delete-bill/${props.house_number}${props.bill_id}`} method="POST">
